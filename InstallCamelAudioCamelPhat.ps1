...
$source = Join-Path $mainFolder "CamelPhatData"
$target = Join-Path $environment.cloudHomeDir "Audio" "Audio Software" "CamelPhat" "CamelPhatData"

# C:\Program Files\Camel Audio\CamelPhat\CamelPhatData
